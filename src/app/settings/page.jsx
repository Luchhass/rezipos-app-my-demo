      ...
      <div className="flex flex-col gap-4 md:gap-6 lg:gap-8 mt-26 md:mt-0 md:ml-70 px-8 py-6 md:px-8 md:py-8 lg:px-8 lg:py-10 select-none lg:max-w-160">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] font-bold opacity-40 text-[#121212] dark:text-white mt-0.5">
                    {notifications
                      ? "Yeni olaylarda anında haberdar ol"
                      : "Bildirimler sessiz"}
                  </p>
                </div>
              </div>
        ...
        <section className="flex flex-col gap-5">
          <div>
            ...
            <p className="text-[13px] font-medium text-gray-400 dark:text-gray-500 mt-2 leading-relaxed">
              Ağa bağlı yazıcılar ve POS terminalleri gibi donanımların bağlantı
              durumunu gösterir.
            </p>
          </div>
          <div className="flex flex-col gap-3">
            {/* Bağlı cihaz */}
            <div className="flex items-center gap-4 px-5 py-4 rounded-2xl bg-[#dddddd] dark:bg-[#2d2d2d]">
              <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-[#a5b4fc]/20 shrink-0">
                <Icons.Printer size={18} className="text-[#a5b4fc]" />
              </div>
            ...
            {/* Bağlı olmayan cihaz */}
            <div className="flex items-center gap-4 px-5 py-4 rounded-2xl bg-[#dddddd] dark:bg-[#2d2d2d] opacity-40">
              <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-black/10 dark:bg-white/10 shrink-0">
                <Icons.Monitor
                  size={18}
              ...
              <div className="flex-1">
                ...
                <p className="text-[11px] font-bold opacity-60 text-[#121212] dark:text-white mt-0.5">
                  Henüz eşleştirilmedi
                </p>
              </div>
              <span className="text-[11px] font-bold text-[#121212] dark:text-white shrink-0">
                Bağlantı yok
              </span>
            </div>
          </div>
        ...
        <section className="flex flex-col gap-5">
          <div>
            ...
            <p className="text-[13px] font-medium text-gray-400 dark:text-gray-500 mt-2 leading-relaxed">
              Uygulamanın mevcut sürümü ve genel çalışma durumu hakkında bilgi
              verir.
            </p>
          </div>
          <div className="flex items-center gap-4 px-5 py-4 rounded-2xl bg-[#dddddd] dark:bg-[#2d2d2d]">
            <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-[#a5b4fc]/20 shrink-0">
              <Icons.ShieldCheck size={18} className="text-[#a5b4fc]" />
            </div>
            <div className="flex-1">
              <p className="text-[14px] font-bold text-[#121212] dark:text-white leading-none">
                Sürüm 2.4.1
              ...
              <p className="text-[11px] font-bold opacity-40 text-[#121212] dark:text-white mt-0.5">
                En güncel sürüm — tüm sistemler normal
              </p>
            </div>
            <div className="flex items-center gap-1.5 shrink-0">
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
